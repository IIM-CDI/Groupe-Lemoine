  ...
  return (
    <div className="flex flex-col p-12 gap-12 min-h-screen bg-cover bg-[url('/images/offers-bg.png')] items-center justify-center  font-san">
      ...
      <div className="flex gap-8 text-black">
        ...
        <select onChange={(e) => setType(e.target.value)} id="offre" name="offre" className="border border-neutral-400">
      ...
      <select onChange={(e) => setExperience(e.target.value)} className="border border-neutral-400">
