...
export default function OfferCard({title, type, experience, description, location, date, onClick}: {title: string, type: string, experience: string, description: string, location: string, date: string, onClick: () => void}) {
    return (
        <div onClick={onClick} className="flex flex-col gap-12 text-black border border-neutral-400 max-w-7xl p-6 justify-center bg-neutral-100 font-sans hover:cursor-pointer hover:bg-neutral-300">
